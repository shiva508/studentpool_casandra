...
public class InboxController {
    ...
    public String homePage(Model model) {
        List<Folder> folders = folderService.findByUserid("dasarishiva.d2@gmail.com");
        List<EmailListItem> emailListItems = emailListItemService.findByKeyIdAndKeyLabel("dasarishiva.d2@gmail.com",
                "Draft ");
